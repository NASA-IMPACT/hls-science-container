...
#define ULX "ULX"
#define ULY "ULY"
#define MSZ  "MEAN_SUN_ZENITH_ANGLE"	/* Removed "(B01)" on Mar 31, 2020 */
#define MSA  "MEAN_SUN_AZIMUTH_ANGLE"
#define MVZ  "MEAN_VIEW_ZENITH_ANGLE"
#define MVA  "MEAN_VIEW_AZIMUTH_ANGLE"
